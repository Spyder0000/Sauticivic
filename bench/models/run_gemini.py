...
def run_gemini(
    ...
    """
    gemini_out = output_dir / "gemini"
    audio_files = discover_audio_files(corpus_dir, clip_id=clip_id, clip_path=clip_path)
...
def _parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--clip", type=Path, default=None, help="Run a single audio file path.")
