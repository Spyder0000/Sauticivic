...
- **Zero Citizen PII:** All recordings were performed using standardized civic scenario prompts. No real citizen names, private telephone numbers, residential street addresses, or private individual details are included in the transcripts or audio.
- **Anonymity & Non-Exploitation:** Audio files and metadata use standardized anonymous identifiers (`SPK-01` through `SPK-05`). No demographic or dialectal attributions are made beyond verified, consented linguistic background.
