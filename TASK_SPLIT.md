...
> ⚠️ drizzy765 and Agoro Timilehin are the same person. Tasks previously split across both are now consolidated under one role.
...
## ⚖️ Scope Rule (Non-Negotiable)
> **The benchmark is what's scored; the frontend is demo-ware.** If Weeks 4–5 get tight, David thins Dashboard/cards to the minimum the demo video needs, and drizzy765 spends reclaimed hours on corpus quality and error analysis.
